...
public class UserPostAdapter extends ArrayAdapter<PostItem> {

    final UserPostsFragment ref;

    public UserPostAdapter(Context context, ArrayList<PostItem> PostItems, UserPostsFragment temp) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View.OnClickListener buttonListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toast.show();
                ref.getLoaderManager().restartLoader(ref.USER_POST_LOADER_ID, null, ref).forceLoad();
            }
        };
